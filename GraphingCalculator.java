...
/**
 * Date: October 4-2022
 * This is a graphing calculator that graphs the functions: x, x^2, x^3, Sqrt(x), Log(x)
...
public class GraphingCalculator extends JFrame{
	...
	public GraphingCalculator() {
		...
		/**
		 * This method calculates the formula y=m(x)+b, then plots the values of x and y on the graph.
		 * @param g A graphics object passed in from paintComponent.
		 */
		...
		/**
		 * This method calculates the formula y=m(x^2)+b, then plots the values of x and y on the graph.
		 * @param g A graphics object passed in from paintComponent.
		 */
		...
		/**
		 * This method calculates the formula y=m(x^3)+b, then plots the values of x and y on the graph.
		 * @param g A graphics object passed in from paintComponent.
		 */
		...
		/**
		 * This method calculates the formula y=m(Sqrt(x))+b, then plots the values of x and y on the graph.
		 * @param g A graphics object passed in from paintComponent.
		 */
		...
		/**
		 * This method calculates the formula y=m(Log(x))+b, then plots the values of x and y on the graph.
		 * @param g A graphics object passed in from paintComponent.
		 */
